...
insert_table = f"ohlcv_1min_binance_{symbol_type.lower()}"
symbol_id = f"BINANCEFTSC_{symbol_type}_BTC_USD"
...
while True:
    ...
    for data in response:
        ...
        high = str(data["price_high"])
        low = str(data["price_low"])
        close = str(data["price_close"])
